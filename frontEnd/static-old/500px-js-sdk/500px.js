...
module.exports = function () {
  ...
  const login_callback = function (callback, parameters) {
  ...
  this.api = function () {
    ...
    var args, url, method, data, tag_src
    ...
    request.get(tag_src, function (err, res) {
      console.log(err)
      console.log(res)
    })
  }
  ...
  this.login = function (callback) {
    ...
    request(site_url + 'api/js-sdk/authorize?sdk_key=' + this.sdk_key, function (err, res) {
      console.log(err)
      login_callback.call(self, callback, res.body)
    })
  }
